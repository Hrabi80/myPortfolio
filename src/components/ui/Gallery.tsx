            ...
            <AnimatePresence>
              {lightboxIndex !== null && (
                <m.div
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="fixed inset-0 z-[60] flex items-center justify-center bg-black/95 p-0 backdrop-blur-sm sm:p-6"
                ...
                >
                  ...
                  <m.div
                    ...
                    className="relative h-screen w-screen overflow-hidden sm:h-[90vh] sm:w-[90vw]"
